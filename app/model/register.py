...
def register_all_models() -> None:
    ...
    common.register_model(claude.VertexAIClaude3_7SonnetNew())
    common.register_model(claude.VertexAIClaude3_5Sonnet())
    common.register_model(claude.VertexAIClaude3_5Haiku())
    common.register_model(claude.VertexAIClaude3Opus())
    common.register_model(claude.VertexAIClaude4Sonnet())
    ...
    common.register_model(gemini.Gemini15ProGeneric())
    common.register_model(gemini.Gemini25ProGeneric())
    common.register_model(gemini.Gemini25ProGenericActual())
