...
def get_text_in_python_file(
    file_full_path:str
) -> str:
    """Gets all the text in a file and returns it as a single string
    ...
    with open(file_full_path) as f:
        file_content = f.readlines()
    string_of_file_content = ""
    for lines in file_content:
        string_of_file_content += lines + " "
    return string_of_file_content
